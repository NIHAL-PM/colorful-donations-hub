    ...
    <div className="min-h-screen relative overflow-hidden">
          ...
          >
            <div className="inline-block rounded-full bg-donation-primary/10 px-4 py-1.5 mb-4">
              <span className="text-sm font-medium text-donation-primary flex items-center">
                <Heart size={14} className="mr-1" fill="#4F9D69" />
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4">
              ...
              <Link to="/leaderboard">
                <Button 
                  variant="outline" 
                  size="lg" 
                  className="px-8 py-6 text-lg border-donation-primary/30 hover:bg-donation-primary/10 hover:border-donation-primary/50 transition-colors w-full sm:w-auto"
                >
      ...
      >
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold">Why Choose Happy Donation?</h2>
      ...
      <footer className="py-8 px-4 container mx-auto max-w-6xl text-center text-gray-600">
        <div className="flex justify-center items-center mb-4">
          <Heart className="h-6 w-6 text-donation-primary mr-2" fill="#4F9D69" />
